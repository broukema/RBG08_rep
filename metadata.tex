...
\def \articleTITLE{[{$\neg$}Rp] Reproducibility of 'Poincar{\'e} dodecahedral space parameter estimates'}
...
\def \replicationCITE{Roukema, B. F.; Buli{\'n}ski, Z.; Gaudin, N. E., 2008, Poincar{\'e} dodecahedral space parameter estimates, Astronomy and Astrophysics, 492, 657-673}
...
\affil[1]{Institute of Astronomy, Faculty of Physics, Astronomy and Informatics, Nicolaus Copernicus University, Grudziadzka 5, 87-100 Toru{\'n}, Poland}
