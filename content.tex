...
difficulties in reproducing RBG08, combined with some coding
...
Nevertheless, also by 2010, {\sc gcc} already claimed to implement
...
Fortran code together have only evolved quite recently\supercite{GCCISOFortranC}.

While the results of the paper are not as trivially reproducible as they
...
format such as {\sc maneage}\supercite{Akhlaghi15,Akhlaghi2020} would be a
